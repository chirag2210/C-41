...
var shrubsGroup, obstaclesGroup, shrub1, shrub2, shrub3, obstacle1;
...
function setup() {
  ...
  jungle = createSprite(400, 100, 800, 20);
...
function draw() {
  ...
  if (gameState === PLAY) {
    ...
    //increase score by 1 for every frame in play state
...
function spawnShrubs() {
  if (frameCount % 150 === 0) {
    ...
    shrub.scale = 0.05;
    shrub.lifetime = 400;
    shrub.setCollider("rectangle", 0, 0, shrub.width-200, shrub.height-200); // corrected collider size
